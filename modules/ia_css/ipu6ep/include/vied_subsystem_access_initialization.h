...
#ifndef VIED_SUBSYSTEM_ACCESS_INITIALIZATION_H_
#define VIED_SUBSYSTEM_ACCESS_INITIALIZATION_H_
 ...
 *  @param[in]   nr_subsystems        The number of subsystems for which the access has to be initialised.
 *  @param[in]   base_addresses       A pointer to an array of base addresses of subsystems.
...
#endif  /* VIED_SUBSYSTEM_ACCESS_INITIALIZATION_H_ */
