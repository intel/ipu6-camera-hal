 ...
 * - no master port is linked to external_config in the yaml file of the core
...
#ifndef DAI_DEVICE_ACCESS_EXTERNAL_CONFIG_H_
#define DAI_DEVICE_ACCESS_EXTERNAL_CONFIG_H_
...
/**
 * @defgroup device_access_simple_external_config DAI - external config device access
 *
 * @addtogroup device_access_simple_external_config
 * @{
 */
/**
 ...
 *		that is assigned for external_config in the core SDK
 *
...
void dai_external_config_store_8(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_external_config_store_16(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_external_config_store_32(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_external_config_store(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint8_t dai_external_config_load_8(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint16_t dai_external_config_load_16(const dai_device_route_t *route,
				     dai_address_t address);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint32_t dai_external_config_load_32(const dai_device_route_t *route,
				     dai_address_t address);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_external_config_load(const dai_device_route_t *route,
...
/**
 * @defgroup device_access_register_external_config DAI - external config register access
 *
 * @addtogroup device_access_register_external_config
 * @{
 */
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_external_config_reg_store_32(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint32_t dai_external_config_reg_load_32(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_external_config_reg_bank_store_32(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint32_t dai_external_config_reg_bank_load_32(const dai_device_route_t *route,
					      dai_device_regbank_id_t bank, int bank_index,
					      dai_device_reg_id_t reg);
/**
 * @}
...
/**
 * @defgroup device_access_memory_external_config DAI - external config memory access
 *
 * @addtogroup device_access_memory_external_config
 * @{
 */
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_external_config_mem_store_8(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_external_config_mem_store_16(const dai_device_route_t *route,
				      dai_device_memory_id_t mem, dai_address_t mem_addr,
				      uint16_t data);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_external_config_mem_store_32(const dai_device_route_t *route,
				      dai_device_memory_id_t mem, dai_address_t mem_addr,
				      uint32_t data);
 ...
 *		port that is assigned for external_config in the core SDK
 *
 * @param[in] route	route to target device
 * @param[in] mem	memory ID
 * @param[in] mem_addr	address relative to base address of memory
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_external_config_mem_store(const dai_device_route_t *route,
				   dai_device_memory_id_t mem, dai_address_t mem_addr,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint8_t dai_external_config_mem_load_8(const dai_device_route_t *route,
				       dai_device_memory_id_t mem, dai_address_t mem_addr);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint16_t dai_external_config_mem_load_16(const dai_device_route_t *route,
					 dai_device_memory_id_t mem, dai_address_t mem_addr);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint32_t dai_external_config_mem_load_32(const dai_device_route_t *route,
					 dai_device_memory_id_t mem, dai_address_t mem_addr);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_external_config_mem_load(const dai_device_route_t *route,
				  dai_device_memory_id_t mem, dai_address_t mem_addr,
...
#endif  /* DAI_DEVICE_ACCESS_EXTERNAL_CONFIG_H_ */
