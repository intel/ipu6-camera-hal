...
#ifndef __IA_CSS_PKG_DIR_IUNIT_DEP_H
#define __IA_CSS_PKG_DIR_IUNIT_DEP_H

/* In bootflow, pkg_dir only supports upto 16 entries in pkg_dir
 * pkg_dir_header + Psys_server pg + Isys_server pg + 13 Client pg
 */

#define IA_CSS_PKG_DIR_PG_FROM_IDX(i) \
	(i == IA_CSS_PKG_DIR_PSYS_INDEX ? IA_CSS_PKG_DIR_PSYS_SERVER_PG : \
	(i == IA_CSS_PKG_DIR_ISYS_INDEX ? IA_CSS_PKG_DIR_ISYS_SERVER_PG : \
	IA_CSS_PKG_DIR_CLIENT_PG))

#define IA_CSS_PKG_DIR_PG_STR_FROM_IDX(i) \
	(i == IA_CSS_PKG_DIR_PSYS_INDEX ? "IA_CSS_PKG_DIR_PSYS_SERVER_PG" : \
	(i == IA_CSS_PKG_DIR_ISYS_INDEX ? "IA_CSS_PKG_DIR_ISYS_SERVER_PG" : \
	"IA_CSS_PKG_DIR_CLIENT_PG"))
