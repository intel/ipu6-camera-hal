...
/**
 * @file
 * @brief Type definitions for subsystem access, this is the layer below the DAI
 */

#ifndef VIED_SUBSYSTEM_ACCESS_TYPES_H_
#define VIED_SUBSYSTEM_ACCESS_TYPES_H_
...
#endif  /* VIED_SUBSYSTEM_ACCESS_TYPES_H_ */
