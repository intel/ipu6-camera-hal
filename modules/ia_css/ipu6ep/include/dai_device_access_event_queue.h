 ...
 * - no master port is linked to event_queue in the yaml file of the core
...
#ifndef DAI_DEVICE_ACCESS_EVENT_QUEUE_H_
#define DAI_DEVICE_ACCESS_EVENT_QUEUE_H_
...
/**
 * @defgroup device_access_simple_event_queue DAI - event queue device access
 *
 * @addtogroup device_access_simple_event_queue
 * @{
 */
/**
 ...
 *		that is assigned for event_queue in the core SDK
 *
...
void dai_event_queue_store_8(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_event_queue_store_16(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_event_queue_store_32(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_event_queue_store(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint8_t dai_event_queue_load_8(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint16_t dai_event_queue_load_16(const dai_device_route_t *route,
				 dai_address_t address);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint32_t dai_event_queue_load_32(const dai_device_route_t *route,
				 dai_address_t address);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_event_queue_load(const dai_device_route_t *route,
...
/**
 * @defgroup device_access_register_event_queue DAI - event queue register access
 *
 * @addtogroup device_access_register_event_queue
 * @{
 */
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_event_queue_reg_store_32(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint32_t dai_event_queue_reg_load_32(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_event_queue_reg_bank_store_32(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint32_t dai_event_queue_reg_bank_load_32(const dai_device_route_t *route,
					  dai_device_regbank_id_t bank, int bank_index,
					  dai_device_reg_id_t reg);
/**
 * @}
...
/**
 * @defgroup device_access_memory_event_queue DAI - event queue memory access
 *
 * @addtogroup device_access_memory_event_queue
 * @{
 */
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_event_queue_mem_store_8(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_event_queue_mem_store_16(const dai_device_route_t *route,
				  dai_device_memory_id_t mem, dai_address_t mem_addr,
				  uint16_t data);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_event_queue_mem_store_32(const dai_device_route_t *route,
				  dai_device_memory_id_t mem, dai_address_t mem_addr,
				  uint32_t data);
 ...
 *		port that is assigned for event_queue in the core SDK
 *
 * @param[in] route	route to target device
 * @param[in] mem	memory ID
 * @param[in] mem_addr	address relative to base address of memory
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_event_queue_mem_store(const dai_device_route_t *route,
			       dai_device_memory_id_t mem, dai_address_t mem_addr,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint8_t dai_event_queue_mem_load_8(const dai_device_route_t *route,
				   dai_device_memory_id_t mem, dai_address_t mem_addr);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint16_t dai_event_queue_mem_load_16(const dai_device_route_t *route,
				     dai_device_memory_id_t mem, dai_address_t mem_addr);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint32_t dai_event_queue_mem_load_32(const dai_device_route_t *route,
				     dai_device_memory_id_t mem, dai_address_t mem_addr);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_event_queue_mem_load(const dai_device_route_t *route,
			      dai_device_memory_id_t mem, dai_address_t mem_addr,
...
#endif  /* DAI_DEVICE_ACCESS_EVENT_QUEUE_H_ */
