 ...
 * - no master port is linked to external_data in the yaml file of the core
...
#ifndef DAI_DEVICE_ACCESS_EXTERNAL_DATA_H_
#define DAI_DEVICE_ACCESS_EXTERNAL_DATA_H_
...
/**
 * @defgroup device_access_simple_external_data DAI - external data device access
 *
 * @addtogroup device_access_simple_external_data
 * @{
 */
/**
 ...
 *		that is assigned for external_data in the core SDK
 *
...
/**
 * @defgroup device_access_register_external_data DAI - external data register access
 *
 * @addtogroup device_access_register_external_data
 * @{
 */
...
/**
 * @defgroup device_access_memory_external_data DAI - external data memory access
 *
 * @addtogroup device_access_memory_external_data
 * @{
 */
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_external_data_mem_store_16(const dai_device_route_t *route,
				    dai_device_memory_id_t mem, dai_address_t mem_addr,
				    uint16_t data);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_external_data_mem_store_32(const dai_device_route_t *route,
				    dai_device_memory_id_t mem, dai_address_t mem_addr,
				    uint32_t data);
 ...
 *		port that is assigned for external_data in the core SDK
 *
 * @param[in] route	route to target device
 * @param[in] mem	memory ID
 * @param[in] mem_addr	address relative to base address of memory
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_external_data_mem_store(const dai_device_route_t *route,
				 dai_device_memory_id_t mem, dai_address_t mem_addr,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint8_t dai_external_data_mem_load_8(const dai_device_route_t *route,
				     dai_device_memory_id_t mem, dai_address_t mem_addr);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint16_t dai_external_data_mem_load_16(const dai_device_route_t *route,
				       dai_device_memory_id_t mem, dai_address_t mem_addr);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint32_t dai_external_data_mem_load_32(const dai_device_route_t *route,
				       dai_device_memory_id_t mem, dai_address_t mem_addr);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_external_data_mem_load(const dai_device_route_t *route,
				dai_device_memory_id_t mem, dai_address_t mem_addr,
...
#endif  /* DAI_DEVICE_ACCESS_EXTERNAL_DATA_H_ */
