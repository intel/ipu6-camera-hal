 ...
 * - no master port is linked to internal_data in the yaml file of the core
...
#ifndef DAI_DEVICE_ACCESS_INTERNAL_DATA_H_
#define DAI_DEVICE_ACCESS_INTERNAL_DATA_H_
...
/**
 * @defgroup device_access_simple_internal_data DAI - internal data device access
 *
 * @addtogroup device_access_simple_internal_data
 * @{
 */
/**
 ...
 *		that is assigned for internal_data in the core SDK
 *
...
void dai_internal_data_store_8(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_internal_data_store_16(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_internal_data_store_32(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_internal_data_store(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint8_t dai_internal_data_load_8(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint16_t dai_internal_data_load_16(const dai_device_route_t *route,
				   dai_address_t address);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint32_t dai_internal_data_load_32(const dai_device_route_t *route,
				   dai_address_t address);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_internal_data_load(const dai_device_route_t *route,
...
/**
 * @defgroup device_access_register_internal_data DAI - internal data register access
 *
 * @addtogroup device_access_register_internal_data
 * @{
 */
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_internal_data_reg_store_32(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint32_t dai_internal_data_reg_load_32(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_internal_data_reg_bank_store_32(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint32_t dai_internal_data_reg_bank_load_32(const dai_device_route_t *route,
					    dai_device_regbank_id_t bank, int bank_index,
					    dai_device_reg_id_t reg);
/**
 * @}
...
/**
 * @defgroup device_access_memory_internal_data DAI - internal data memory access
 *
 * @addtogroup device_access_memory_internal_data
 * @{
 */
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_internal_data_mem_store_8(const dai_device_route_t *route,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_internal_data_mem_store_16(const dai_device_route_t *route,
				    dai_device_memory_id_t mem, dai_address_t mem_addr,
				    uint16_t data);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_internal_data_mem_store_32(const dai_device_route_t *route,
				    dai_device_memory_id_t mem, dai_address_t mem_addr,
				    uint32_t data);
 ...
 *		port that is assigned for internal_data in the core SDK
 *
 * @param[in] route	route to target device
 * @param[in] mem	memory ID
 * @param[in] mem_addr	address relative to base address of memory
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_internal_data_mem_store(const dai_device_route_t *route,
				 dai_device_memory_id_t mem, dai_address_t mem_addr,
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint8_t dai_internal_data_mem_load_8(const dai_device_route_t *route,
				     dai_device_memory_id_t mem, dai_address_t mem_addr);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint16_t dai_internal_data_mem_load_16(const dai_device_route_t *route,
				       dai_device_memory_id_t mem, dai_address_t mem_addr);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
uint32_t dai_internal_data_mem_load_32(const dai_device_route_t *route,
				       dai_device_memory_id_t mem, dai_address_t mem_addr);
 ...
 */
_DAI_DEVICE_ACCESS_INLINE
void dai_internal_data_mem_load(const dai_device_route_t *route,
				dai_device_memory_id_t mem, dai_address_t mem_addr,
...
#endif  /* DAI_DEVICE_ACCESS_INTERNAL_DATA_H_ */
