...
const char* IntelAlgoServerThreadName(int index) {
    ...
    static const char* gIpcCmdMapping[IPC_CPU_GROUP_NUM] = {
        "AiqCPUAlgoServer", "PalCPUAlgoServer",   "PsysCPUAlgoServer",
        "FdCPUAlgoServer",  "OtherCPUAlgoServer"};
